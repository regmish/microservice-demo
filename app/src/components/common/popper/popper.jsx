...
import { PopperPaper } from './popper-paper';
        ...
        anchorEl && isOpen && (
          <MuiPopper
            ...
            className={clsx(
              classes.popper,
              {
                [classes.popperTop]: placement.indexOf('top') > -1 && formattedModifiers.arrow,
                [classes.popperBottom]: placement.indexOf('bottom') > -1 && formattedModifiers.arrow,
                [classes.popperLeft]: placement.indexOf('left') > -1 && formattedModifiers.arrow,
                [classes.popperRight]: placement.indexOf('right') > -1 && formattedModifiers.arrow,
              },
              className,
            )}
            open={isOpen}
            ...
            {...props}
          >
            <span className={clsx({ [classes.arrow]: !!formattedModifiers.arrow })} ref={setArrowRef} />
            <ClickAwayListener onClickAway={onClickAway}>
              <PopperPaper className={clsx({ [classes.noPadding]: noPadding })} {...paperProps}>
